...
public class Lua_UnityEngine_Rigidbody2D : LuaObject {
	...
	static public int SetRotation(IntPtr l) {
		try {
			...
			else if(matchType(l,argc,2,typeof(UnityEngine.Quaternion))){
				UnityEngine.Rigidbody2D self=(UnityEngine.Rigidbody2D)checkSelf(l);
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function SetRotation to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int MoveRotation(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function MoveRotation to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int OverlapCollider(IntPtr l) {
		try {
			...
			#endif
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,2,typeof(UnityEngine.ContactFilter2D),typeof(LuaOut))){
				UnityEngine.Rigidbody2D self=(UnityEngine.Rigidbody2D)checkSelf(l);
				UnityEngine.ContactFilter2D a1;
				checkValueType(l,2,out a1);
	...
	static public int GetContacts(IntPtr l) {
		try {
			...
			else if(matchType(l,argc,2,typeof(UnityEngine.ContactFilter2D),typeof(List<UnityEngine.ContactPoint2D>))){
				UnityEngine.Rigidbody2D self=(UnityEngine.Rigidbody2D)checkSelf(l);
				UnityEngine.ContactFilter2D a1;
				checkValueType(l,2,out a1);
	...
	static public int GetAttachedColliders(IntPtr l) {
		try {
			...
			#endif
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,2,typeof(LuaOut))){
				UnityEngine.Rigidbody2D self=(UnityEngine.Rigidbody2D)checkSelf(l);
				UnityEngine.Collider2D[] a1;
				checkArray(l,2,out a1);
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function GetAttachedColliders to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int Cast(IntPtr l) {
		try {
			...
			else if(matchType(l,argc,2,typeof(UnityEngine.Vector2),typeof(List<UnityEngine.RaycastHit2D>),typeof(float))){
				UnityEngine.Rigidbody2D self=(UnityEngine.Rigidbody2D)checkSelf(l);
				UnityEngine.Vector2 a1;
				checkType(l,2,out a1);
				System.Collections.Generic.List<UnityEngine.RaycastHit2D> a2;
				checkType(l,3,out a2);
				System.Single a3;
				checkType(l,4,out a3);
				var ret=self.Cast(a1,a2,a3);
			...
			else if(matchType(l,argc,2,typeof(UnityEngine.Vector2),typeof(UnityEngine.ContactFilter2D),typeof(List<UnityEngine.RaycastHit2D>),typeof(float))){
				UnityEngine.Rigidbody2D self=(UnityEngine.Rigidbody2D)checkSelf(l);
				UnityEngine.Vector2 a1;
				checkType(l,2,out a1);
				UnityEngine.ContactFilter2D a2;
